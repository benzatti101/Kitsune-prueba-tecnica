  ...
  methods: {
    ...
    generateTableColumns(firstRecord) {
      ...
      const columnLabels = [
        ...
        "Año",                   // columna[2]
        "Género",                // columna[3]
        "Categoría Edad",        // columna[4]
        "Nivel Estudios",        // columna[5]
        "Estado Civil",          // columna[6]
        "Etnia",                 // columna[7]
        "Código País",           // columna[8]
        "Localización",     // columna[9]
        "Oficina Reg.",          // columna[10]
        "Puesto Votación",       // columna[11]
        "Localización",     // columna[12]
        "Proceso Electoral",     // columna[13]
        "Mes Inscripción",       // columna[14]
        "Cantidad Personas",      // columna[15]
        "Cantidad Inscritos",      // columna[16]
        "Cantidad Total"           // columna[17]
      ];
